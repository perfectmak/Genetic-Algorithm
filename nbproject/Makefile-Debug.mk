...
${OBJECTDIR}/example/SortBooks/Book.o: example/SortBooks/Book.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++0x -MMD -MP -MF $@.d -o ${OBJECTDIR}/example/SortBooks/Book.o example/SortBooks/Book.cpp

${OBJECTDIR}/example/SortBooks/BookArrangement.o: example/SortBooks/BookArrangement.cpp 
	${MKDIR} -p ${OBJECTDIR}/example/SortBooks
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++0x -MMD -MP -MF $@.d -o ${OBJECTDIR}/example/SortBooks/BookArrangement.o example/SortBooks/BookArrangement.cpp

${OBJECTDIR}/example/SortBooks/run.o: example/SortBooks/run.cpp 
	${MKDIR} -p ${OBJECTDIR}/example/SortBooks
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++0x -MMD -MP -MF $@.d -o ${OBJECTDIR}/example/SortBooks/run.o example/SortBooks/run.cpp
...
${OBJECTDIR}/src/GeneticAlgorithm.o: src/GeneticAlgorithm.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++0x -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/GeneticAlgorithm.o src/GeneticAlgorithm.cpp
